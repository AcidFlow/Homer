...
case class OwmForecast(coord : OwmCoordinate, weather : List[OwmWeather], base : String, main : OwmMain, visibility: Int, wind : OwmWind, clouds : OwmClouds, dt : Long, sys : OwmSys, id : Int, name : String, cod : Int)

case class OwmCoordinate(lon : Double, lat : Double)
