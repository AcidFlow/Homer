...
case class SlotValueDuration(years: Int, quarters: Int, months: Int, weeks: Int, days: Int, hours: Int, minutes: Int, seconds: Int, precision : String) extends SlotValue
